...
const Navbar = () => {
  ...
  return (
    <Nav>
        <NavbarContainer>
        <NavLogo to = "/">Parth Dholakiya</NavLogo>
...

        {
            ...
            <MobileMenu isOpen={isOpen}>
                ...
                <NavLink onClick={() => setIsOpen(!isOpen)} href="#Experiance">Experiance</NavLink>
                ...
                <GithubButton href={Bio.github} target='Blank' style={{background: theme.primary,
